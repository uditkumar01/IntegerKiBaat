...
export default function Home({signInWithGoogle}) {
    return (
        <>
                ...
                <div className="home-left-content">
                    <div className="home-left">
                        <h1 className={`home-title`}>
                            Connect with iChat, the best club house app
                        </h1>
                ...
                <div className="home-right-content">
                    {/* <div className={"home-right"}>
                        <div className={`video-screen`}>
                            ...
                            <span className={`msg-here one`}>
                                {" "}
                                I am here !!!
                            </span>
                            <span className={`msg-here two`}>
                                {" "}
                                Looks amazing ...
                            </span>
                            <span className={`msg-here three`}>
                                {" "}
                                Iam good :{")"}
                            </span>
                            <span className={`msg-here four`}>
                                {" "}
                                Busy now ? :{"!"}
                            </span>
                        </div>
                    ...
                    <iframe
                        width="560"
                        height="315"
                        src="https://www.youtube-nocookie.com/embed/AOKo1S2r7RU"
            ...
            {/* https://vvaibhavdesai.github.io/hosted_asset/mobile-view.JPG */}
        </>
    );
}
