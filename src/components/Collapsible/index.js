  ...
  return (
    <div className={`collapsible`}>
      ...
      >
        <span>{title}</span>
        <i
          className={collapsibleOpen ? "ion-chevron-up" : "ion-chevron-down"}
        ></i>
      </p>
      <ul
        className={
          collapsibleOpen ? `collapsible-items close` : `collapsible-items`
        }
      >
        {prevRooms ? (
            ...
            return (
              <li
                ...
                onClick={() => {
                  ...
                  toast.success(`copied room Id for '${name}'`, {
