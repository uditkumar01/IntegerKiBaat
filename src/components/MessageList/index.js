      ...
      /> */}
                ...
                <div className="message-list-container">
                    {messages.map((msg, i) => {
                        ...
                        let isMine =
                            current.author._id === auth.currentUser.uid;
                        ...
                        if (previous) {
                            ...
                            prevBySameAuthor =
                                previous.author._id === current.author._id;

                            if (
                                prevBySameAuthor &&
                                previousDuration.as("hours") < 1
                            ) {
                        ...
                        if (next) {
                            ...
                            nextBySameAuthor =
                                next.author._id === current.author._id;

                            if (
                                nextBySameAuthor &&
                                nextDuration.as("hours") < 1
                            ) {
                                endsSequence = false;
                            }
                        }
